...
$smtp_answer = fgets($fp, 1024);
if($debug > 0){echo "HELO {$_SERVER['SERVER_NAME']}<br>"; echo "$smtp_answer<br>";}
...
if(substr($smtp_answer,0,3) == 553){
    if($debug > 0){echo "$smtp_answer<br>"; echo "&lt;" . $smtpFrom . "&gt;<br>";}
    if($debug > 0){echo "QUIT<br>"; echo "Disconnected.<br>";}
